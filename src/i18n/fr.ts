...
const fr: typeof en = {
    ...
    lab: {
        ...
        insight: {
            ...
            detectTitle: 'Sortie détecteur',
            detectEmptyTitle: 'Aucun finding détecteur pour le moment',
            detectEmptyBody: 'Les compteurs de sévérité apparaissent quand InSight promeut des preuves en rapports.',
