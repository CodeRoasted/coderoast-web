...
export default function ProductNavbar() {
    ...
    const onLogCraft = location.pathname === '/logcraft'
    ...
    /**
     * `Pricing` lives as an anchor inside /logcraft — when the visitor is
     * already on that page, scroll to it; otherwise navigate.
     */
    const pricingHref = onLogCraft ? '#pricing' : '/logcraft#pricing'
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden lg:flex items-center gap-7">
                        ...
                        <a href={pricingHref} className={navLinkBase}>
                            {t.nav.pricing}
                        </a>
                        <NavLink
                            to="/tiers"
