...
/**
 * Friendly upsell modal shown when the backend rejects an action with
 * 403 because the current user's tier is too low. Replaces the silent
 * 4-second status toast that prospects never read.
 */
            ...
            {error && (
                ...
                >
                    ...
                    >
                        ...
                        <div className="inline-flex p-2.5 rounded-xl bg-gradient-to-br from-brand-600 to-orange-500 text-white mb-4">
                            <Lock className="w-5 h-5" />
                        </div>

                        <h2 className="font-display text-xl font-bold text-white mb-2">
                            {t.auth.tierLockTitle}
                        </h2>
